...
public class BusCombistuble {
    ...
    public BusCombistuble(int numeroPasajeros, int numeroPuertas, int capacidadMaletero, int numBolsasAire, int numEjes,
            int numSalidasEmergencia, boolean aireAcondicionado, boolean camaraReversa, boolean abs) {
