...
public class PickUpCombustible extends  VehiculoCombustible{
    ...
    public PickUpCombustible(int capacidadTanque, int numerPasajeros, int numPuertas, int capacidadMaletero,
